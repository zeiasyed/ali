(() => {
  ...
  async function playCorrectSound() {
    ...
    // Louder hero power-up / POW!
    tone(ctx, { freq: 196, type: "sawtooth", start: 0, dur: 0.12, gain: 0.22, slideTo: 392 });
    tone(ctx, { freq: 392, type: "square", start: 0.09, dur: 0.12, gain: 0.28 });
    tone(ctx, { freq: 523, type: "square", start: 0.18, dur: 0.12, gain: 0.28 });
    tone(ctx, { freq: 659, type: "square", start: 0.27, dur: 0.14, gain: 0.3 });
    tone(ctx, { freq: 784, type: "triangle", start: 0.34, dur: 0.2, gain: 0.2 });
    tone(ctx, { freq: 1175, type: "triangle", start: 0.42, dur: 0.25, gain: 0.14 });
  }
  ...
  async function playWrongSound() {
    ...
    // Comic boing — still clear on phone speakers
    tone(ctx, { freq: 360, type: "triangle", start: 0, dur: 0.16, gain: 0.26, slideTo: 120 });
    tone(ctx, { freq: 200, type: "square", start: 0.1, dur: 0.14, gain: 0.18, slideTo: 80 });
  }
  ...
  async function playStartSound() {
    ...
    const ctx = audioCtx;
    if (!ctx) return;
    // Short “ready for action” cue so you know sound is on
    tone(ctx, { freq: 440, type: "square", start: 0, dur: 0.08, gain: 0.2 });
    tone(ctx, { freq: 660, type: "square", start: 0.08, dur: 0.1, gain: 0.22 });
  }
